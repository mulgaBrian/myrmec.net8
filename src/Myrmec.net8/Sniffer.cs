...
namespace Myrmec.net8
{
  ...
  public class Sniffer
  {
    ...
    public List<string> Match(byte[] data, bool matchAll = false)
    {
      ...
      if (matchAll || extentionStore.Count == 0)
      {
    ...
    private static void Add(byte[] data, Node parent, string[] extentions, int depth)
    {
    ...
    private static void Match(byte[] data, int depth, Node node, List<string> extentionStore, bool matchAll)
    {
